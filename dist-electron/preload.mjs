...
electron.contextBridge.exposeInMainWorld("ipcRenderer", {
  ...
  mergeToLibrary: async (presentations) => electron.ipcRenderer.invoke("merge-to-library", presentations),
  ...
  // Security API
  getApiKey: async () => electron.ipcRenderer.invoke("get-api-key"),
  setApiKey: async (key) => electron.ipcRenderer.invoke("set-api-key", key)
});
